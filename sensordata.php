...
if (isset($_GET['addpassword']) && $_GET['addpassword'] == $sensorpwd) {
  ...
  $sensor_temperature = $_GET['temperature'];
  ...
  $sql = "INSERT INTO $db_table_sensordata (id,sensorid,date,time,temperature,humidity) VALUES ('','$sensor_id','$sensor_date','$sensor_time','$sensor_temperature','$sensor_humidity');";
